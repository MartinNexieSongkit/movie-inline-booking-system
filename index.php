...
<html lang="en">
    ...
    <body id="page-top">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Movie Seat Reservation</a>
       ...
       ?>
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">MartinNex © 2024- Movie Seat Reservation System</div></div>
        </footer>
        <!-- Bootstrap core JS-->
